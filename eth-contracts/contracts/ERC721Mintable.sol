...
event ownerShipTransfer(address newOwner);
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(address(0) != newOwner, "The new address is not valid");
...
contract Pausable is Ownable {
     ...
     event contractisPaused(address);
     event contractisUnpaused(address);
    ...
    function setUnpaused() public onlyOwner{
            _paused = false;
            emit contractisUnpaused(msg.sender);
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        // TODO require the given address to not be the owner of the tokenId
            require(to != _tokenOwner[tokenId], "The owner cannot be the given address");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
          bool y_n = isApprovedForAll(_tokenOwner[tokenId], msg.sender);
          if( !y_n){
               require(msg.sender == _tokenOwner[tokenId], "owner must be the sender or Approved for all");
          }
    ...
    function getApproved(uint256 tokenId) public view returns (address) {
        ...
        address approvedToken = _tokenApprovals[tokenId];
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        // function transferFrom(address from, address to, uint256 tokenId) public {
            //transferFrom(msg.senderm to, toeknId)
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        // TODO: require from address is the owner of the given token
            require(_tokenOwner[tokenId] == from, "Transferee must have ownership of the token");

        // TODO: require token is being transfered to valid address
            require(address(0) != to, "Must be a valid non 0 address");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    string memory concatTokenString = strConcat(_baseTokenURI, stringTokenId);

        _tokenURIs[tokenId] =concatTokenString;
...
//contract DecentralizedHousingLedger is ERC721Metadata("Realty Housing Decentralized Ledger", "RHDL", 
//"https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/"){

 contract DecentralizedHousingLedger is ERC721Metadata{
